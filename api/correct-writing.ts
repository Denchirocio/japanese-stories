...
Vas a recibir una foto de un texto escrito a mano en japonés, junto con la gramática objetivo (obligatoria), una gramática opcional (bonus, no obligatoria), los sustantivos, verbos, adjetivos y lugares que debía usar, y el tema que se le pidió al estudiante.
...
5. Además de la gramática objetivo (obligatoria), vas a recibir una "Gramática opcional (bonus)" — NO es obligatoria y no se penaliza si no aparece. Si el estudiante la usó correctamente en algún lugar del texto (en cualquier forma apropiada), marcá "usedBonusGrammar": true y asigná entre 3 y 8 puntos extra en "bonusPoints" (más puntos si la usó de forma natural y repetida, menos si fue un uso simple pero correcto). Si no la usó, o la usó mal, "usedBonusGrammar": false y "bonusPoints": 0. Si la usó bien, agregá un punto más al final de "explanation" con título tipo "Punto extra" y la descripción celebrando el uso de esa gramática opcional.
6. Asigná un puntaje general de 0 a 100 evaluando: la extensión (un texto completo de 6+ oraciones, no unas pocas líneas sueltas), el uso correcto de la gramática objetivo, el uso de los sustantivos/verbos/adjetivos/lugares pedidos, y la naturalidad general. Sé exigente pero justo: 90+ es excelente y completo, 70-89 es bueno pero corto o con errores menores, menos de 70 es muy corto o tiene errores importantes. Al final, sumale "bonusPoints" a este puntaje (sin pasarte de 100).
7. Además del puntaje general, evaluá por separado estas 4 destrezas, cada una de 0 a 100 con un comentario de una sola frase corta en español:
...
{"transcription": "...", "corrected": "...", "explanation": [{"title": "...", "description": "..."}], "usedRequiredElements": true, "usedWords": ["...", "..."], "usedBonusGrammar": false, "bonusPoints": 0, "score": 85, "breakdown": {"handwriting": {"score": 90, "comment": "..."}, "grammar": {"score": 85, "comment": "..."}, "vocabulary": {"score": 100, "comment": "..."}, "naturalness": {"score": 80, "comment": "..."}}}`
